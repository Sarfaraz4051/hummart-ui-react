...
export const categories_data = [
  {
    ...
    des:
      "Pulses, Atta, Rice, Dry Fruits, Oil, Ghee, Spices, Salt, Sugar, Vinegar & Dressing",
    img_url: "1.jpg",
  },
  {
    title: "Noodles Sauces & Frozen Foods",
    des: `Noodles, Baking & Dessert Items, Sauces & Ketchups, Pasta & Soups, Jam, Honey &
    Spreads`,
    img_url: "2.jpg",
  },
  {
  ...
  {
    title: "Baby & Kids",
    des: `Pulses, Atta, Rice, Dry Fruits, Oil, Ghee, Spices, Salt, Sugar, Vinegar &
    Dressing`,
    img_url: "5.jpg",
  },
  {
  ...
  },
  {
    ...
    des: "Fruits, Vegetables, Cut Frsh, Sprouts & Herbs",
    img_url: "7.jpg",
  },
  {
    title: "Personal Care",
    des:
      "Bath & body, Hair Care, Skin Care, Oral care, Face care,Shaving needs, Health & Wellness",
    img_url: "8.jpg",
  },
  {
    title: "Furnishing & Home Needs",
    des:
      " Bedding, Curtains & Home Decor, Bathing Needs,Mats & Carpets, Furniture & Storage, Travelling Bags,Electrical Goods, Stationery & Magazines",
    img_url: "9.jpg",
  },
  {
    title: "Home Services",
    des: "Electrical Works, Plumbing, AC Maintenance, Handyman, Laundry",
    img_url: "10.jpg",
  },
];
export let para = `Ever wondered of entering a grocery store and getting an overview of
